...
public class CenterstageTeleOpRobot extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            {
                {//Drivetrain Driver Controls (Driver 1)
                    //Drone Launcher set off
                    if (gamepad1.y) {
                        droneLauncher.setPosition(-1);
                    }
                    // Drone Launcher Reset
                    if (gamepad1.a) {
                        droneLauncher.setPosition(0);
                    }
//Manipulator Controls (Driver 2)
                    //Claw open
                    if (gamepad2.a) {
                        claw.setPosition(0);
                    }
