...
//@Disabled
public class HardwareMapDistanceTeach {
...
//----------------------------Initialize Robot ---------------------------------
  ...
  */
   ...
   public void CalculateDriveTime(double centimeters, double radius, double speed) throws InterruptedException {
//Calculates number of Milliseconds to move desired amount cetimeters
